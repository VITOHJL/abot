...
from abot.config.schema import TelegramConfig
...
class _FakeBot:
    ...
    async def get_me(self):
        return SimpleNamespace(username="abot_test")
...
async def test_start_uses_request_proxy_without_builder_proxy(monkeypatch) -> None:
    ...
    monkeypatch.setattr("abot.channels.telegram.HTTPXRequest", _FakeHTTPXRequest)
    monkeypatch.setattr(
        "abot.channels.telegram.Application",
